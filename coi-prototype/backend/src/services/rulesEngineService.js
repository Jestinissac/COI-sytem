...
import { updateRulesEngineHealth, getRulesEngineStatus, resetRulesEngine as resetImpactEngine } from './impactAnalysisService.js'
...
export function validateWithFallback(fieldId, change) {
