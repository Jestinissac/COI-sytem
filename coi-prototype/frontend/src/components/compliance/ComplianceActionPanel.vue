  ...
  <div class="bg-white rounded-lg p-4">
    ...
    <div class="flex items-center gap-3 pt-4 border-t border-gray-200">
      ...
      <button 
        ...
        class="flex-1 inline-flex items-center justify-center px-4 py-2 border border-primary-500 bg-blue-50 text-blue-700 rounded-lg hover:bg-blue-100 transition-colors font-medium text-sm"
      >
        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
