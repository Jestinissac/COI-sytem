    ...
    <div class="px-4 py-3 border-b border-gray-200 bg-gray-50">
      <div class="flex items-center justify-between">
        ...
        <button
          ...
          :disabled="loading"
          class="px-2 py-1 text-xs text-blue-600 hover:text-blue-800 disabled:opacity-50"
        >
      ...
      <div v-else-if="impact" class="space-y-4">
        ...
        <div v-if="impact.dependencies && impact.dependencies.length > 0">
          <div class="flex items-center justify-between mb-2">
            ...
            <span class="text-xs font-semibold text-blue-600">{{ impact.dependencies.length }}</span>
          </div>
