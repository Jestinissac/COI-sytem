          ...
          <div class="flex items-center justify-between px-8 py-6 border-b border-gray-200">
            ...
            <div class="flex items-center gap-3">
              ...
              <button
                v-if="data.length > 0"
                @click="handleExport"
                class="flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors"
            ...
            <div v-if="data.length > pageSize" class="px-8 py-4 border-t border-gray-200 flex items-center justify-between">
              ...
              <div class="flex items-center gap-2">
                <button
                  ...
                  class="px-3 py-1.5 text-sm border border-gray-300 rounded hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
